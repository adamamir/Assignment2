...
public class Assignment2 {
	...
	public static void main(String[] args) {
		...
		do {
			System.out.print("Welcome to Jewellery Shop. What is your name? ");
			String name = sc.next();
			System.out.print("Hello, " +name +". Would you like to look at some recomendations from our shop? (Choose Y or N) ");
